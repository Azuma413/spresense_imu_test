...
from model import IMUDataset, IMUPredictor
import numpy as np
from tqdm import tqdm

def train(model, train_loader, valid_loader, num_epochs=50, device='cuda'):
...
def main():
    try:
        ...
        # Training
        train(model, train_loader, valid_loader, device=DEVICE)
